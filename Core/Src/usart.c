...
void MX_UART4_Init(void)
{
  ...
  */
  ...
  USART_InitStruct.BaudRate = SLAVE_BAUD;
  USART_InitStruct.DataWidth = SLAVE_DATAWIDTH;
  USART_InitStruct.StopBits = SLAVE_STOPBITS;
  USART_InitStruct.Parity = SLAVE_PARITY;
...
void MX_USART1_UART_Init(void)
{
  ...
  */
  ...
  USART_InitStruct.BaudRate = MASTER_BAUD;
  USART_InitStruct.DataWidth = MASTER_DATAWIDTH;
  USART_InitStruct.StopBits = MASTER_STOPBITS;
  USART_InitStruct.Parity = MASTER_PARITY;
  USART_InitStruct.TransferDirection = LL_USART_DIRECTION_TX_RX;
  USART_InitStruct.HardwareFlowControl = LL_USART_HWCONTROL_NONE;
  USART_InitStruct.OverSampling = LL_USART_OVERSAMPLING_16;
